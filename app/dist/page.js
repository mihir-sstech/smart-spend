...
function Home() {
    ...
    return (React.createElement("div", { className: '', key: "hom-section-first-11" },
        React.createElement("header", { className: "bg-#FFFFFF text-black", key: "header12", style: { backgroundColor: 'white' } },
            React.createElement("div", { className: "container mx-auto flex flex-col md:flex-row justify-between items-center py-4 bg-#FFFFFF", key: "container" },
                React.createElement("div", { className: "flex items-center mb-4 md:mb-0", key: "logo" },
                    React.createElement(link_1["default"], { href: "#" },
                        React.createElement(image_1["default"], { src: "/Smar-SpendLogo-.png", alt: "Icon", className: "mr-2", width: 80, height: 80 })),
                    React.createElement(link_1["default"], { href: "#" },
        ...
        React.createElement("div", { className: "bg-slate-100 max-w-full container flex flex-col md:flex-row justify-center items-center  mx-auto", key: "content", style: { backgroundColor: 'white' } },
            ...
            React.createElement("div", { className: "mt-8 md:mt-0", key: "text" },
                React.createElement("h2", { className: "text-lg font-extrabold", key: "title" },
                    ...
                    React.createElement("span", { className: "font-extrabold text-[#E53A36] text-4xl" }, "S"),
                    React.createElement("span", { className: "font-extrabold text-4xl" }, "pend.")),
