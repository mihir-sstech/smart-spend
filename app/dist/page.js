...
function Home() {
    ...
    return (React.createElement("div", { className: '', key: "hom-section-first-11" },
        React.createElement("header", { className: "bg-slate-100 text-black", key: "header12" },
            React.createElement("div", { className: "container mx-auto flex flex-col md:flex-row justify-between items-center py-4", key: "container" },
                React.createElement("div", { className: "flex items-center mb-4 md:mb-0", key: "logo" },
                    React.createElement(image_1["default"], { src: "/Smar-SpendLogo-.svg", alt: "Icon", className: "mr-2", width: 80, height: 80 }),
                    React.createElement(image_1["default"], { src: "/Rectangle.png", alt: "Icon", className: "mr-2", width: 230, height: 54 })),
                React.createElement("nav", { className: "flex flex-col md:flex-row", key: "nav" },
                    ...
                    React.createElement("a", { href: "https://sstechstudio.com/single_expense/pages/index/privacy-policy", target: "_blank", rel: "noopener noreferrer" },
                        React.createElement("button", { className: "mx-4 mb-2 md:mb-0 font-body font-semibold", key: "policy-button" }, "Privacy Policy")),
        ...
        React.createElement("div", { className: "bg-slate-100 max-w-full container flex flex-col md:flex-row justify-center items-center  mx-auto", key: "content" },
            ...
            React.createElement("div", { className: "mt-8 md:mt-0", key: "text" },
                React.createElement("h2", { className: "text-lg font-extrabold", key: "title" },
                    ...
                    React.createElement("span", { className: "font-extrabold text-[#1380E7] text-4xl" }, "Budget. "),
                    React.createElement("span", { className: "font-extrabold  text-[#009852] text-4xl" }, "Thrive.")),
                ...
                React.createElement("div", { className: "flex mt-4", key: "store-buttons" },
                    React.createElement("div", { className: "inline-block mr-4", key: "download-section-first-6" },
                        React.createElement("a", { href: "https://play.google.com/store/apps/details?id=sstech.com.singleexpense", target: "_blank", rel: "noopener noreferrer" },
                            React.createElement(image_1["default"], { src: "/Google-Play-Store.png", width: 250, height: 73, alt: "Google Play Button", className: "h-11 w-auto", style: { width: "150px" } }))),
                    React.createElement("div", { className: "inline-block", key: "download-section-first-7" },
                        React.createElement("a", { href: "https://apps.apple.com/us/app/wallet-income-expense-tracker/id1445995357", target: "_blank", rel: "noopener noreferrer" },
                            React.createElement(image_1["default"], { src: "/Apple-Play-Store.png", width: 250, height: 73, alt: "App Store Button", className: "h-11 w-auto", style: { width: "150px" } })))))),
        ...
        React.createElement("div", { id: "features", className: "bg-slate-100 container max-w-full  mx-auto", key: "features-section" },
        ...
        React.createElement("div", { id: "heltcenter", className: "bg-slate-100 container max-w-full mx-auto", key: "helpcenter-section" },
        ...
        React.createElement("div", { id: "contact-us", className: "bg-slate-100 container max-w-full mx-auto", key: "helpcenter-section" },
