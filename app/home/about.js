            ...
            <div className="max-w-4xl px-4" key="about-section-first">
                ...
                <div className='md:p-8' style={{ animation: 'slideIn 1s forwards' }}>
                    <div className="flex flex-col mx-auto" key="about-section-first-half">
                        <p className="text-xl text-gray-700 text-center md:text-base mb-4">
                        ...
                        <p className="text-xl text-gray-700  font-medium text-center md:text-base mb-4">
                        ...
                        <p className="text-xl text-gray-700 text-center font-medium md:text-base mb-4">
