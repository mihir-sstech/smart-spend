...
const About = () => {
    return (
        ...
        <div className="container mx-auto px-4 mt-10" key="help-section-first-12">
            <h1 className="text-3xl font-bold mb-4 text-center">Help Center</h1>
            <div className="container flex flex-col md:flex-row justify-center items-center" key="help-section-first-13">
                ...
                <div className="mt-8 md:mt-0" key="help-section-first-14">
                    <h2 className="text-lg font-extrabold">
                        ...
                        <span className="font-bold text-[#E53A36] text-2xl">Spend Help Center</span>
                    </h2>
                    <p className="text-sm mt-2 md:mt-4 max-w-sm " key="help-section-first-15">Regular updates and user manuals are readily available for your convenience.</p>
